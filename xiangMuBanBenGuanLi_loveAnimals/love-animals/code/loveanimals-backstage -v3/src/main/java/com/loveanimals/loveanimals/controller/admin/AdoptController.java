...
public class AdoptController {
    ...
    @ApiOperation(value = "根据用户id查询领养信息")
    @GetMapping("/check/getAdoptBy")
    public Map<String,Object> getAdoptBy(Integer buserid){
        Map<String,Object> map=new HashMap<>();

        List<Adopt> adoptList= adoptService.findAdoptByBuserid(buserid);
        map.put("code","200");
        map.put("msg","success");
        map.put("count",adoptList.size());
        map.put("data",adoptList);
