...
public class BuserController {
    ...
    public Map<String,Object> add(String bname,String username,String bpwd,MultipartFile headphoto,HttpServletRequest request,String status){
        Map<String,Object> map=new HashMap<>();
    ...
    @GetMapping("/check/getcollection")
    ...
    @GetMapping("/check/getprivateletter")
